          ...
          <footer className="bg-navy text-white py-8 mt-20">
                <div className="max-w-6xl mx-auto px-4">
                        <div className="grid md:grid-cols-3 gap-8 mb-6">
                                  <div>
                                              <h3 className="font-bold text-lg mb-3">キャリアスコア診断</h3>h3>
                                  ...
                                  <div>
                                              <h3 className="font-bold text-lg mb-3">サービス</h3>h3>
                                  ...
                                  <div>
                                              <h3 className="font-bold text-lg mb-3">リンク</h3>h3>
                                              <ul className="text-sm text-gray-300 space-y-2">
                                                            <li>
                        ...
                        <div className="border-t border-gray-600 pt-6 text-center text-sm text-gray-400">
                                  <p>© 2026 Growth Empowerment. All rights reserved.</p>p>
                        </div>div>
                </div>div>
          </footer>footer>
        );
