          ...
          <div className="gradient-bg text-white rounded-xl p-8 shadow-lg">
                <div className="text-center">
                        ...
                        <div className="max-w-2xl mx-auto mb-8">
                                  <div className="grid md:grid-cols-3 gap-4 mb-8">
                                              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                                            ...
                                                            <p className="font-semibold">診断結果の詳細解説</p>p>
                                              </div>div>
                                              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                                            <div className="text-3xl mb-2">🎯</div>div>
                                                            <p className="font-semibold">課題を解決する具体策</p>p>
                                              </div>div>
                                              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                                            <div className="text-3xl mb-2">🤝</div>div>
                                                            <p className="font-semibold">最適な人材紹介会社のご紹介</p>p>
                                              </div>div>
                                  </div>div>
                        ...
                        <div className="border-t border-white/20 pt-6 max-w-2xl mx-auto">
                                  <h3 className="text-xl font-bold mb-4">相談後の流れ</h3>h3>
                                  <div className="grid md:grid-cols-3 gap-4 text-sm">
                                              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                                                            <div className="font-bold mb-2">STEP 1</div>div>
                                                            <p>診断結果を基に<br />課題を明確化</p>p>
                                              </div>div>
                                              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                                                            <div className="font-bold mb-2">STEP 2</div>div>
                                                            <p>あなたに最適な<br />人材紹介会社をご紹介</p>p>
                                              </div>div>
                                              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                                                            <div className="font-bold mb-2">STEP 3</div>div>
                                                            <p>プロのサポートで<br />転職成功へ</p>p>
                                              </div>div>
                                  </div>div>
                        </div>div>
                        ...
                        <div className="mt-8 text-xs text-gray-300 max-w-2xl mx-auto">
                                  <p className="mb-2">
                                              ご予約いただいた情報は、相談対応および
                                              <strong className="text-white">人材紹介会社への情報共有</strong>strong>
                                              のみに使用します。
                                  </p>p>
